...
slider_positions = {
    'sigma': {'x': 30, 'y': HEIGHT + 30, 'min': 0.0, 'max': 50.0, 'value': sigma},
    'rho': {'x': 280, 'y': HEIGHT + 30, 'min': 0.0, 'max': 50.0, 'value': rho},
    'beta': {'x': 530, 'y': HEIGHT + 30, 'min': 0.0, 'max': 10.0, 'value': beta},
    'scale': {'x': 30, 'y': HEIGHT + 80, 'min': 1.0, 'max': 50.0, 'value': scale},
    'dt': {'x': 280, 'y': HEIGHT + 80, 'min': 0.001, 'max': 0.02, 'value': dt},
    'speed': {'x': 530, 'y': HEIGHT + 80, 'min': 1, 'max': 20, 'value': speed},  # New speed slider
}

# Buttons
pause_button_rect = pygame.Rect(280, HEIGHT + 120, 80, 30)
reset_button_rect = pygame.Rect(380, HEIGHT + 120, 80, 30)
...
while running:
    ...
    if not paused:
        # Perform 'speed' number of simulation steps per frame
