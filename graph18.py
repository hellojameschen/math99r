...
pygame.display.set_caption("Animated Force-Directed Graph with Dijkstra Wavefront and Barycentric Refinement")
...
def draw_ui(screen, iterations_per_frame, zoom_level, num_nodes, edge_prob, energy, input_active, input_boxes, 
            refresh_button_hover, drag_mode, drag_mode_hover, highlight_distance, refine_button_hover):
    ...
    while running:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if input_boxes['refresh_button']['rect'].collidepoint(event.pos):
                    try:
                        ...
                        if num_nodes == 3 and edge_prob == 1.0:
                            ...
                            nodes, adj_matrix, triangles = generate_random_graph(num_nodes, edge_prob)
                ...
                elif input_boxes['drag_mode_button']['rect'].collidepoint(event.pos):
        ...
        # Handle hover state for refresh, refine, and drag mode buttons
        ...
        if mouse_buttons[0]:  # Left mouse button
            ...
            if not ((50 <= mouse_x <= 250 and HEIGHT - PANEL_HEIGHT + 20 <= mouse_y <= HEIGHT - PANEL_HEIGHT + 80) or
                    ...
                    input_boxes['refine_button']['rect'].collidepoint((mouse_x, mouse_y))):
        ...
        draw_ui(screen, iterations_per_frame, zoom_level, 
                ...
                energy,
                input_active, input_boxes, refresh_button_hover, drag_mode, drag_mode_button_hover, highlight_distance, refine_button_hover)
        pygame.display.flip()
        clock.tick(60)
