...
def draw_panel(screen, bodies, trail_fade_speed, paused, boundary_dropdown, input_boxes, scale, time_speed_multiplier):
...
def main():
    ...
    while running:
        ...
        draw_panel(screen, bodies, trail_fade_speed, paused, boundary_dropdown, input_boxes, scale, time_speed_multiplier)
