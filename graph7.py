...
# Physics parameters
REPULSION_STRENGTH = 1000  # Increased strength for better separation
ATTRACTION_STRENGTH = 0.1  # Strength of the attraction along edges
...
def draw_ui(screen, iterations_per_frame, zoom_level, num_nodes, edge_prob, energy, input_active, input_boxes, refresh_button_hover):
